...
You start with n_generations_remaining=${numberOfSections}. Always decrement n_generations_remaining by 1 from the previous section when generating the next section. When n_generations_remaining=0, use an 'end_section'.`,
